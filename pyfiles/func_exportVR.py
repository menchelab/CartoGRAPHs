...
# UPLOAD CSV 
# ----------------------------
def exportVRNetzer_CSV(filename, G, posG, d_node_colors, d_annotations, linkcolor,clusterlabels):
    """
    ...
    return print("Exported Files: \n", 
            [filename+'_nodepositions.csv', 
            filename+'_nodecolors.csv', 
            filename+'_nodeproperties.csv', 
            filename+'_links.csv', 
            filename+'_linkcolors.csv', 
            filename+'_clusterlabels.csv'])
