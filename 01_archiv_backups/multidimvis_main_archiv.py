...
# cluster functions
def get_node_clusterid(df, n_clus, n_iterations = 10):
...
def color_nodes_from_dict(G, l_gene, colour):
...
def color_edges_from_genelist(G, l_nodes, color):
